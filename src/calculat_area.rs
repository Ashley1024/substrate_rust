...
fn calculat_main(){
    ...
    cal_circle.set_radius(6);
    let cal_circle = crate::calculat_area::shape::shape::Area::area_format(&cal_circle); 

    println!("circle area: {}", cal_circle);
 
    let mut cal_rectangle = crate::calculat_area::shape::shape::Rectangle::new();
    cal_rectangle.set_w_h(10, 10);
    println!("rectangle area: {}", crate::calculat_area::shape::shape::Area::area_format(&cal_rectangle));

    // let mut cal_triangle
    let mut cal_triangle: shape::shape::Triangle = crate::calculat_area::shape::shape::Triangle::new();
    cal_triangle.set_w_h(10, 10);
    println!("triangle area: {}", crate::calculat_area::shape::shape::Area::area_format(&cal_triangle));
